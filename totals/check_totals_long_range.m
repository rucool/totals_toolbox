...
% the codar database
totals_realtime(system_type, database_session,...
        'region', 7,...
        'hours', 4,...
        'pattern_select', 4,...
        'version', 1,... #version of the totals processing
        'radial_directory', '/Users/mikesmith/Documents/projects/bpu/new_zones/primary_recommendation/',...
