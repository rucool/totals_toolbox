...
switch system_type
    ...
    case 3
        ...
        conf.Radials.Types = {'RDLi', 'RDLi', 'RDLi','RDLi','RDLi','RDLi'}; %remove belm august 31, 2012
        conf.Radials.MaskDir = ['./mask_files/BPU_2km_extendedMask.txt'];% MASK FILE
...
%         conf.OI.AsciiDir = [saveDir 'totals/maracoos/oi/ascii/13MHz' suffix];
    ...
    case 2
        conf.Radials.Types = {'RDLm', 'RDLm', 'RDLm', 'RDLi', 'RDLm', 'RDLm', 'RDLi', 'RDLi', 'RDLm', 'RDLi', 'RDLi', 'RDLm', 'RDLm', 'RDLi', 'RDLi', 'RDLi', 'RDLi'}; 
        conf.Radials.Sites = {'NAUS', 'NANT', 'MVCO', 'BLCK', 'AMAG', 'MRCH', 'HEMP', 'HOOK', 'LOVE', 'BRIG', 'WILD', 'ASSA', 'CEDR', 'LISL', 'DUCK', 'HATY', 'CORE'}; %Current
        ...
        % OI Configuration
        conf.OI.BaseDir = [saveDir 'totals/maracoos/oi/5MHz/'];
        conf.OI.FilePrefix = strcat('tuv_oi_',conf.Totals.DomainName,'_');
        conf.OI.FileSuffix = '.mat';
        conf.OI.mdlvar = 420;
        conf.OI.errvar = 66;
