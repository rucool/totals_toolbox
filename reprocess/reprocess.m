...
end_time = datenum(2018,4,1,0,0,0);
system_type = 2;
radial_directory = '/home/codaradm/data/radials/';
% save_directory = '/Users/mikesmith/Documents/';
% radial_directory = '/Users/mikesmith/Documents/projects/maracoos/new_zones/wind';
save_directory = '/Users/mikesmith/Documents/projects/maracoos/reprocess/';
...
for x = 1:1:length(time_steps)
    ...
    try
        ...
        codar_driver_totals(time_steps(x), conf, system_type);
    catch
